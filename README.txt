...
This plugin lets you to create beautiful, filterable and responsive portfolios.

== Description ==

This plugin will help you to create and manage multiple portfolios for your website with different set of items and individual settings.

The portfolio is rendered on the front end using a simple shortcode [simple_folio id="put portfolio id here"]

[Demo Link](http://wp-dynamo.presstigers.com/basic/portfolio)
